...
@EnableBinding({RocketMQProduceApplication.MySource.class})
...
//	}
    ...
    @Bean
    public CustomRunner customRunnerTest() {
        return new CustomRunner("output1");
    }
    ...
    public static class CustomRunner implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
            ...
            testStudent.setStudentName("王大锤");
            testStudent.setSchoolName("王炸研究院");
            testStudent.setAddress("天堂镇");
            testStudent.setFavourites("play games");
            testStudent.setPhoneNumber("186 8888 6666");
            senderService.sendObject(testStudent,"default-tag");
